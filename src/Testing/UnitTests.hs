...
taxTests = ConfigTests "Configs/Tests/TaxTestConfigurations.xml"
           [
             ...
             ("440kTest_FedOnly+SD",1,[FMCTest "Fed Tax On 440k (w/ Standard Deduction)" (isFinalNW (MoneyValue 308565 USD))]),
             ("440kTest_FedOnly+5kItemized",1,[FMCTest "Fed Tax On 440k (w/ SD + 5k Itemized Deduction)" (isFinalNW (MoneyValue 303565 USD))]),
             ("440kTest_FedOnly+20kItemized",1,[FMCTest "Fed Tax On 440k (w/ SD + 20k Itemized Deduction)" (isFinalNW (MoneyValue 292065 USD))]),
             ...
             ("1MMTest_SALTCap",1,[FMCTest "Fed_NYS+NYC Tax On 1MM (w/10k SALT Cap)" (isFinalNW (MoneyValue 538356 USD))]),
             ...
             ("CapitalGainFedOnly_200k",1,[FMCTest "200k Capital Gain (Fed Only)"
                                           (andTests [isFinalNW (MoneyValue 330875 USD),
                                                      isFinalAcctValue "Vanguard" (MoneyValue 0 USD),
                                                      isFinalAcctValue "Bank" (MoneyValue 300000 USD),
                                                      isFinalAcctValue "Sweep" (MoneyValue 30875 USD)])]),
             ("CapitalGainFedOnly_1MM",1,[FMCTest "1MM Capital Gain (Fed Only)"
                                           (andTests [isFinalNW (MoneyValue 1054875 USD),
                                                      isFinalAcctValue "Vanguard" (MoneyValue 0 USD),
                                                      isFinalAcctValue "Bank" (MoneyValue 1000000 USD),
                                                      isFinalAcctValue "Sweep" (MoneyValue 54875 USD)])]),
             ...
             ("CapitalGainAndIncomeFedOnly1",1,[FMCTest "25k Capital Gain + 1MM income Fed Only"
                                               (andTests [isFinalNW (MoneyValue 882775 USD),
                                                          isFinalAcctValue "Vanguard" (MoneyValue 50000 USD),
                                                          isFinalAcctValue "Bank" (MoneyValue 150000 USD),
                                                          isFinalAcctValue "Sweep" (MoneyValue 682775 USD)])]),
             ("CapitalGainAndIncomeFedOnly2",1,[FMCTest "25k Capital Gain + 440k income Fed Only"
                                                (andTests [isFinalNW (MoneyValue 549615 USD),
                                                           isFinalAcctValue "Vanguard" (MoneyValue 50000 USD),
                                                           isFinalAcctValue "Bank" (MoneyValue 150000 USD),
                                                           isFinalAcctValue "Sweep" (MoneyValue 349615 USD)])]),
             ("CapitalGainFed+NYS+NYC",1,[FMCTest "Capital Gain (1MM income) Fed+NYS+NYC"
                                      (andTests [isFinalNW (MoneyValue 818140.35 USD),
                                                 isFinalAcctValue "Vanguard" (MoneyValue 50000 USD),
                                                 isFinalAcctValue "Bank" (MoneyValue 150000 USD),
                                                 isFinalAcctValue "Sweep" (MoneyValue 618140 USD)])]),
             ("FundInterest (Fed)",1,[FMCTest "Fund Interest Fed Only" (isFinalNW (MoneyValue 1003392 USD))]),
             ("FundDividends (Fed)",1,[FMCTest "Fund Dividends Fed Only" (isFinalNW (MoneyValue 1005875 USD))]),
